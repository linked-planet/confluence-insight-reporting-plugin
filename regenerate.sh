...
mvn archetype:generate -B -U \
    ...
    "-Dpackage=com.linkedplanet.plugin.confluence.insightreporting" \
    "-DnameHumanReadable=Insight Reporting for Confluence" \
    "-Ddescription=Automatic creation of Confluence pages from data stored in Mindville Insight" \
    "-DorganizationNameHumanReadable=linked-planet GmbH" \
    "-DorganizationUrl=https://linked-planet.com" \
    "-DinceptionYear=2018" \
    "-DdeveloperConnection=scm:git:https://github.com/linked-planet/confluence-insight-reporting-plugin.git" \
